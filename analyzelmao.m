...
for isubject = 1:nsubjects
   ...
   % EEG = pop_firws(EEG, 'fcutoff', [0.3 30], 'ftype', 'bandpass', 'wtype', 'hamming', 'warg', 5.65326, 'forder', 50, 'minphase', 0,'plotfresp',true);
    ...
    words_filename = ['C:\Users\ema36\OneDrive\Documents\fNIRS&Gerbils\', subID, '_alltrialwords.mat'];
    load(words_filename)
    ...
    all_click_info = readtable('C:\Users\ema36\OneDrive\Documents\fNIRS&Gerbils\fNIRSandGerbils.xlsx','FileType','spreadsheet','Format','auto');
    ...
    stim_info_filename = ['C:\Users\ema36\OneDrive\Documents\fNIRS&Gerbils\',strtrim(curr_subject_ID(isubject,:)),'_alltrialwords.mat'];
