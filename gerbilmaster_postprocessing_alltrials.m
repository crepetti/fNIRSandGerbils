...
curr_subject_ID =  char('7024');%char('7002','7004','7007','7008','7010','7023','7024','7033','7035','7036','7038','7039','7040');
...
for isubject = 1:size(curr_subject_ID,1)
    ...
    epochs_filename = join([dir,'prepro_epoched_data/',strtrim(curr_subject_ID(isubject,:)),'all_epoch.mat'],'');
